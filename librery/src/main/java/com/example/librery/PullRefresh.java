...
/**
 * Created by orchid on 16-9-13.
 */
public class PullRefresh  extends ListView implements OnScrollListener{
        ...
        public PullRefresh(Context context, AttributeSet attrs, int defStyle) {
